...
Main_character_artem::Main_character_artem() {
    ...
    set_sprites_texture(runningSprites, all_basic_artem, running_points, next_x_run, next_y_run,0,10,400,470);
    //---------------------------------
	...
	set_sprites_texture(shotingSpritesShoting1, all_basic_artem, shoting1_points, next_x, next_y, 10, 0,400,470);
    //---------------------------------
	...
	//cout << "============================" << endl;
	set_sprites_texture(shotingSpritesShoting2, all_basic_artem, shoting2_points, next_x_shot2, next_y_shot2, 40, 0,400,473);
    //---------------------------------
    set_point(shoting2_point,59 ,661);
	set_sprite(sprite_shoting_2, all_basic_artem, shoting2_point,400,474);
    ...
    set_sprites_texture(reload_sprites, all_basic_artem2, reload_points, next_x_reload, next_y_reload, 10, -20,400,470);
    //granade throw
	//cout << "cwel" << endl;
    ...
    set_sprites_texture(granadeSprites, all_basic_artem2, granade_points, next_granade_x, next_granade_y, 10, 0,380,450);
    //cout << "cwel2" << endl;
...
void Main_character_artem::set_sprites_texture(vector <sf::Sprite>& sprites, sf::Texture &texture, vector<vector<float>> points, float next_x, float next_y,float corrections_x,float corrections_y,float x,float y) {
...
void Main_character_artem::set_sprite(sf::Sprite &sprite,sf::Texture &texture, sf::Vector2f point,float x,float y) {
